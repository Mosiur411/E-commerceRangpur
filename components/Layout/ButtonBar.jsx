        ...
        <main>
            <nav class="fixed max-h-20 bottom-0 inset-x-0 bg-cool-gray-500 text-xs text-gray-600 shadow-inner">
                <div class="max-w-screen-xl mx-auto lg:px-2 gap-x-4 flex justify-between overflow-x-scroll">
                    ...
                    <a href="/page/brands" title="All brands" class="w-full block py-2 px-3 lg:pb-5 text-center hover:bg-gray-200 transition duration-300">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1 mx-auto">
                            <path
                    ...
                    <a href="/page/categories" title="All categories" class="w-full block py-2 px-3 lg:pb-5 text-center hover:bg-gray-200 transition duration-300">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1 mx-auto">
                    ...
                    <a href="/page/search" title="Search" class="w-full block py-2 px-3 lg:pb-5 text-center hover:bg-gray-200 transition duration-300">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1 mx-auto">
                            <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                        Search
                    </a>
                    <a href="/price-list" title="Price list" class="w-full block py-2 px-3 lg:pb-5 text-center hover:bg-gray-200 transition duration-300">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1 mx-auto">
                            <path d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                        Pricelist
                    </a>
                    <a href="/user/liked" title="My likes" class="w-full block py-2 px-3 lg:pb-5 text-center hover:bg-gray-200 transition duration-300">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1 mx-auto">
                    ...
                    <a href="/user/cart" title="Price in Kenya" class="w-full block py-2 px-3 lg:pb-5 text-center hover:bg-gray-200 transition duration-300">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1 mx-auto">
