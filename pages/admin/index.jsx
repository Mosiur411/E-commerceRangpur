...
import { useAdminDeletePostMutation, useAdminGetProductQuery } from '../../app/features/api/ProductControl'

export default function index() {
  const { data } = useAdminGetProductQuery("phone")
              ...
              data?.map(data => <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex justify-end gap-4">
                    ...
                    <Link href={`admin/update/${data?._id}`} x-data="{ tooltip: 'Edite' }" >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
